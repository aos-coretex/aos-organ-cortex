 ...
 *
 * Uses createLLMClient (bug #8 — direct call with shared-lib field names) or
 * an injectedLlm for testability (matches Nomos/Senate precedent — cleaner
 * than env-var tricks because it tests both the happy path and the degraded
 * path without touching global state).
 *
